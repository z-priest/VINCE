...
urlpatterns = [
    ...
    path('ajax_calls/org/', views.autocomplete_org),
    path('ajax_calls/productname/', views.load_product_names),
    ...
    re_path('contact/edit/product/modify/(?P<pk>[0-9]+)/$', views.EditProduct.as_view(), name='editproduct'),
